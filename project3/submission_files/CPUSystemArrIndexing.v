...
module CPUSystemSimulationArrayMax();
    ...
    initial begin
        ...
        CPUSys.ALUSys.DMU.DM.RAM_DATA[8'hB2] = 8'hAA; CPUSys.ALUSys.DMU.DM.RAM_DATA[8'hB3] = 8'h55; // 0x55AA (21930) 
        ...
        CPUSys.ALUSys.DMU.DM.RAM_DATA[8'hB8] = 8'h00; CPUSys.ALUSys.DMU.DM.RAM_DATA[8'hB9] = 8'hFF; // 0xFF00 (65280)
        CPUSys.ALUSys.DMU.DM.RAM_DATA[8'hBA] = 8'hA9; CPUSys.ALUSys.DMU.DM.RAM_DATA[8'hBB] = 8'h55; // 0x55A9 (21929)
        ...
        F.CheckValues(CPUSys.ALUSys.DMU.DM.RAM_DATA[8'hBC], 8'hAA, test_no, "MEM[0xBC] (Max Value LSB)");
        F.CheckValues(CPUSys.ALUSys.DMU.DM.RAM_DATA[8'hBD], 8'h55, test_no, "MEM[0xBD] (Max Value MSB)");
        F.CheckValues(CPUSys.ALUSys.RF.R2.Q, 16'h55AA, test_no, "R2 (Max Value in Register)");
