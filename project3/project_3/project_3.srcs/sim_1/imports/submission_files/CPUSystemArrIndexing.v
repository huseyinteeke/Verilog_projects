...
CPUSys.ALUSys.DMU.DM.RAM_DATA[8'hB0] = 8'h34; CPUSys.ALUSys.DMU.DM.RAM_DATA[8'hB1] = 8'h12; // 0x1234 (4660)
                CPUSys.ALUSys.DMU.DM.RAM_DATA[8'hB2] = 8'hAA; CPUSys.ALUSys.DMU.DM.RAM_DATA[8'hB3] = 8'h55; // 0x55AA (21930) <-- MAX ÝRTÝFA
                ...
                CPUSys.ALUSys.DMU.DM.RAM_DATA[8'hB8] = 8'h00; CPUSys.ALUSys.DMU.DM.RAM_DATA[8'hB9] = 8'hFF; // 0xFF00 (-256) Sensör kalibrasyon dalgalanmasý
                CPUSys.ALUSys.DMU.DM.RAM_DATA[8'hBA] = 8'hA9; CPUSys.ALUSys.DMU.DM.RAM_DATA[8'hBB] = 8'h55;
        // CheckValues'u LSB = 7F, MSB = 00, R2 = 007F olacak þekilde güncellemen gerekir.
        // Sonucun yazýlacaðý BC ve BD adreslerini temizle
        CPUSys.ALUSys.DMU.DM.RAM_DATA[8'hBC] = 8'h00; 
        CPUSys.ALUSys.DMU.DM.RAM_DATA[8'hBD] = 8'h00; 

        // Ýþlemciyi 0x00 adresinden baþlat
